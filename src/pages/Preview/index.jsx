...
export function Preview() {
  const tags = 'Ficção científica, Drama, Família';
  return (
    <Container>
      <Header />
        <main>
          <Content>
            <Section>
                ...
                <div className='data-informations'>
                  ...
                  <p>Por Vinícius Araújo</p>
                  <div className='datetime-content'>
                    <FiClock size={20} />
                    <p>14/08/23 às 10:27</p>
                  </div>
                </div>
                <div className='tags'>
                  {tags.split(',').map(tag => <Tag key={tag} title={tag} />)}
                </div>
                <p>
                  ...
                  foi aberto perto de Saturno e que ele leva a planetas que podem oferecer condições de sobrevivência para a espécie humana. As 
                  "missões Lázaro" enviadas anos antes identificaram três planetas potencialmente habitáveis orbitando o buraco negro Gargântua: 
                  ...
                  agitado por ondas enormes. Uma onda atinge a tripulação enquanto Amelia tenta recuperar os dados de Miller, matando Doyle 
